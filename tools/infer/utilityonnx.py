...
def init_args():
    ...
    parser.add_argument("--rec_model_dir", type=str, default='models_v1/rec_onnx/model.onnx')
    ...
    args = Dict({
        ...
        'precision': 'fp32',
        'det_algorithm': 'DB',
        'det_model_dir': 'models_v1/det_db_inference',
        ...
        'beta': 1.0,
        'fourier_degree': 5,
        'rec_model_dir': 'models_v1/rec_db_inference',
